using RocCurveAICalculator;

using System;
using System.Collections.Generic;
using System.Windows.Forms;

namespace TprFprCalculatorAndRocCurveVisualizator
{
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < InitialDataTable.ColumnCount; i++)
            {
                ...
                for (int j = 0; j < InitialDataTable.RowCount; j++)
                {
                    ...
                    {
                        MessageBox.Show("All cells in table must have a value.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
                }
            }
